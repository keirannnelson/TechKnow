...
DATA_STRUCTURES = {'Trie', 'Binary Indexed Tree', 'String', 'Hash Table', 'Graph', 'Stack',
...
def show_question_flow(topic, question_list):
    ...
    # Data structure MCQ
    answers2 = get_answer_choice(question['data_structures'], DATA_STRUCTURES)
    pf.print_data_structures_question(answers2)
    user_sel = get_abcd_multi()
    user_answers2 = [answers2[ABCD_TO_INDEX[c]] for c in user_sel]
    pf.print_feedback([], user_answers2, [], answers2)
